...
router.post('/api/verify-admin', authController.verifyAdminCredentials);
...
router.post('/api/verify-fnumber', authMiddleware, usersController.verifyFnumber);
router.post('/api', authMiddleware, usersController.createUser);
router.post('/api/authenticate', usersController.authenticateUser);
router.post('/api/verify2fa', usersController.verify2FA);
router.post('/api/finalize-login', usersController.finalizeLogin);
router.post('/api/checkUserBranches', usersController.checkUserBranches);
router.post('/api/track2FAStatus', usersController.track2FAStatus);




router.get('/api', authMiddleware, usersController.getAllUsers);


router.put('/api/:id', authMiddleware, usersController.updateUser);


router.delete('/api/:id', authMiddleware, usersController.deleteUser);
...
router.get('/api/check-telephone/:telephone', visitorsController.checkTelephoneExists);
router.get('/api/index', visitorsController.getAllBranches);
router.get('/api/index/branch', visitorsController.getVisitorLogsByBranchCode);
router.get('/api', visitorsController.getAllVisitorLogs);
router.get('/api/by-phone', visitorsController.getVisitorLogsByPhoneNumber);
router.get('/api/:id', visitorsController.getVisitorLogById);
router.post('/api/', visitorsController.createVisitorLog);
router.put('/api/:id', visitorsController.updateVisitorLog);
router.delete('/api/:id', visitorsController.deleteVisitorLog);
